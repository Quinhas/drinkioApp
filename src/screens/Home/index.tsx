...
const categories = [
  {
    ...
    bgImage: "https://www.thecocktaildb.com/images/media/drink/rrtssw1472668972.jpg",
  },
  {
    desc: "Cocktail",
    bgImage: "https://www.thecocktaildb.com/images/media/drink/yqvvqs1475667388.jpg",
  },
  {
    desc: "Shake",
    bgImage: "https://www.thecocktaildb.com/images/media/drink/rvwrvv1468877323.jpg",
  },
  {
    desc: "Other/Unknown",
    bgImage: "https://www.thecocktaildb.com/images/media/drink/tqxyxx1472719737.jpg",
  },
];
    ...
    <ScrollView py={"1rem"} minH={"100vh"}>
      ...
      <Flex mx={"1.5rem"} mt={"1rem"}>
        ...
        <Box w={"100%"} height={"12.5rem"} borderRadius={"lg"} position={"relative"} shadow={"2"}>
          ...
          />
          <Box w={"100%"} h={"100%"} zIndex={"2"} position={"absolute"} borderRadius={"lg"} bg={"rgba(0,0,0,0.1)"} />
          <Box
            w={"100%"}
            h={"100%"}
            zIndex={"1"}
